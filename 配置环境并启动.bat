...
set "EXE=release\NoVoice\NoVoice.exe"

rem Prefer Python 3.10~3.12
set "PY=python"
...
echo No release exe found. Run: powershell -ExecutionPolicy Bypass -File scripts\build-release.ps1
pause
